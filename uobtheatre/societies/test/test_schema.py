...
def test_societies_schema(gql_client_flexible, gql_id):
...
@pytest.mark.django_db
def test_slug_single_schema(gql_client_flexible, gql_id):
    ...
    response = gql_client_flexible.execute(request % societies[0].slug)
