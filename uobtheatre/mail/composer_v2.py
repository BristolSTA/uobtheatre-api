...
class VenueBlock(ComposerItemInterface):
    ...
    def _stack_items(self):
        items = [
            ...
            ListItem(
            title="Address:",
            message=self.venue.address.building_name + ", " + self.venue.address.building_number + " " + self.venue.address.street + ", " + self.venue.address.city + ", " + self.venue.address.postcode,
            title_icon="compass",
            ),
        ]
